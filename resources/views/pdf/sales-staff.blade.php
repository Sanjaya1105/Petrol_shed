...
<head>
    ...
    <style>
        ...
        .logo-cell { text-align: right; width: 36%; }
                    ...
                    <tr>
                        <td colspan="6" style="padding: 0;">
                            <table style="width: 100%; border-collapse: collapse;">
                                <tr>
                                    <td style="width: 20%; border: 0; border-top: 1px solid #333;"><strong>Cash amount</strong><br>{{ $group['cash_total'] }}</td>
                                    <td style="width: 20%; border: 0; border-top: 1px solid #333;"><strong>Visa/Master</strong><br>{{ $group['visa_master_total'] }}</td>
                                    <td style="width: 20%; border: 0; border-top: 1px solid #333;"><strong>Amex</strong><br>{{ $group['amex_total'] }}</td>
                                    <td style="width: 20%; border: 0; border-top: 1px solid #333;"><strong>Bill amount</strong><br>{{ $group['bill_amount'] }}</td>
                                    <td style="width: 20%; border: 0; border-top: 1px solid #333;"><strong>Short</strong><br>{{ $group['short_total'] }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
